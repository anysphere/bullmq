...
export declare class Job<DataType = any, ReturnType = any, NameType extends string = string> implements MinimalJob<DataType, ReturnType, NameType> {
    ...
    toJSON(): Omit<this, "discard" | "scripts" | "queue" | "toJSON" | "asJSON" | "asJSONSandbox" | "update" | "updateProgress" | "log" | "clearLogs" | "remove" | "extendLock" | "moveToCompleted" | "moveToFailed" | "isCompleted" | "isFailed" | "isDelayed" | "isWaitingChildren" | "isActive" | "isWaiting" | "queueName" | "prefix" | "queueQualifiedName" | "getState" | "changeDelay" | "changePriority" | "getChildrenValues" | "getDependencies" | "getDependenciesCount" | "waitUntilFinished" | "moveToDelayed" | "moveToWaitingChildren" | "promote" | "retry" | "addJob">;
    /**
